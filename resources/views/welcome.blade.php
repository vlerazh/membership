...
<body data-spy="scroll" data-target="#header-navbar" data-offset="51">
    ...
    <div id="page-container" class="fade">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="nav navbar-nav navbar-right">
                        @if(Auth::user() && Auth::user()->subscriptions()->active()->count() >= 1)
                            <li><a href="{{ route('courses.choose') }}" data-click="scroll-to-target">DASHBOARD</a></li>
                        @endif
                        <li class="active">
        ...
        <div id="home" class="content has-bg home">
            ...
            <div class="content-bg">
                <img src="{{ asset("img/bg/bg-home.jpg") }}" alt="Home" />
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
            <div class="container home-content">
                <h1>Welcome to Membership App</h1>
                        ...
                        <div class="pricing-container">
                            ...
                            <div class="price">
                                <div class="price-figure">
                                    <span class="price-number">{{ number_format($plan->cost, 2)  }}$</span>
                                </div>
                            </div>
                            <ul class="features">
                                <li>1GB Storage</li>
                            ...
                            <div class="footer">
                                <a href="{{ route('plans.show', $plan->slug) }}" class="btn btn-inverse btn-block">Buy Now</a>
                            </div>
                        </div>
                    </li>
                    @endforeach
	...
	<script src="{{ asset('js/one-page-parallax/apps.min.js') }}"></script>
	<!-- ================== END BASE JS ================== -->
